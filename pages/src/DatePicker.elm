...
{-| Taken from <https://github.com/fabhof/elm-ui-datepicker/blob/master/src/DatePicker.elm>

while <https://github.com/fabhof/elm-ui-datepicker/issues/8> is unresolved
