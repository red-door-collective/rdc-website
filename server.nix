let
  awsKeyId = "eviction-tracker-production"; # symbolic name looked up in ~/.ec2-keys or a ~/.aws/credentials profile name
  region = "us-east-1";
...
in
{
  network.description = "A website for tracking court data without a paywall.";
